package com.example.beepoo.jwt;
...
public class JwtUtil {
    ...
    //JwtUtil 클래스 생성자 호출 이후에 실행되어 Key 필드에 값을 주입
    @PostConstruct //딱 한번만 받아오면 되는 값을  사용 할 때마다  요청을 새로 호출하는 실수를 방지하기 위해 사용
    public void init() {
    ...
    public String substringToken(String tokenValue) {
        ...
        //ToDo[07] : NullPointer 아닌 다른것으로 바꿔야 할 듯
